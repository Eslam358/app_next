...
const Page = () => {
  ...
  const validateForm = () => {
    ...
    else if (phone.length < 8) errors.phone = "Phone number is too short";
  ...
  return (
    <>
            ...
            <div className="max-w-xl lg:max-w-3xl">
              ...
              >
                <div className="col-span-6 sm:col-span-3">
                  ...
                  <input
                    onChange={(e) => handel(e.target.value, setFirstName)}
                    value={firstName}
                    type="text"
                    id="FirstName"
                    name="first_name"
                ...
                <div className="col-span-6 sm:col-span-3">
                  ...
                  <input
                    onChange={(e) => handel(e.target.value, setLastName)}
                    value={lastName}
                    type="text"
                    id="LastName"
                    name="last_name"
                ...
                <div className="col-span-6">
                  ...
                  <input
                    ...
                    className="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm"
                  />
                  <p className="ml-2  text-xs text-secondary">{errors.email}</p>
                </div>
                ...
                <div className="col-span-6">
                  ...
                  <input
                    onChange={(e) => handel(e.target.value, setPhone)}
                    value={phone}
                    className="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm"
                    type="tel"
                    id="phone"
                  />
                  <p className="ml-2  text-xs text-secondary">{errors.phone}</p>
                </div>
                ...
                <div className="col-span-6 sm:col-span-3">
                  ...
                  <input
                    onChange={(e) => handel(e.target.value, setConfirmPassword)}
      ...
      <SnackBars text={"jjjjjjjj"} state={false} />
    </>
  );
};
